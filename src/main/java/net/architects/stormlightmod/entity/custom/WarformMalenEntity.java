...
public class WarformMalenEntity extends RosharanHostileEntity implements IAnimatable {

    private AnimationFactory factory = new AnimationFactory(this);

    public WarformMalenEntity(EntityType<? extends HostileEntity> entityType, World world) {
