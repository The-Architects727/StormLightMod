...
public class GreenShardplateArmorRenderer extends GeoArmorRenderer<GreenShardplateArmorItem> {
    public GreenShardplateArmorRenderer() {
        super(new GreenShardplateArmorModel());
