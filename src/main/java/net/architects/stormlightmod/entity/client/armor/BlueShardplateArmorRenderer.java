...
public class BlueShardplateArmorRenderer extends GeoArmorRenderer<BlueShardplateArmorItem> {
    public BlueShardplateArmorRenderer() {
        super(new BlueShardplateArmorModel());
