...
public class WhiteShardplateArmorItem extends ModArmorItem implements IAnimatable {
    ...
    public WhiteShardplateArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.WHITE_SHARDPLATE_BOOTS,
