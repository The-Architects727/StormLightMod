...
public class LightGreyShardplateArmorItem extends ModArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public LightGreyShardplateArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.LIGHT_GREY_SHARDPLATE_BOOTS,
